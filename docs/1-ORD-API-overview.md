...
The software [Open Radar Data API](https://api.meteogate.eu/eu-eumetnet-weather-radar/docs) and the related [Open Radar Data Ingest API](https://radar.meteogate.eu/ingest/) (EUMETNET Members only) are located at [European Weather Cloud](https://europeanweather.cloud/) (EWC). 
